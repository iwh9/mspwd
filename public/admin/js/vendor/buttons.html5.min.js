(function(i) {
    ...
    function z(a) {
        for (var b = ""; 0 <= a;) b = String.fromCharCode(a % 26 + 65) + b,
        a = Math.floor(a / 26) - 1;
        return b
    }
    function A(a, b) {
    ...
    function q(a, b, d) {
        ...
        d && (d.attr && i(c).attr(d.attr), d.children && i.each(d.children,
        function(a, b) {
            c.appendChild(b)
    ...
    function K(a, b) {
        ...
        for (var f = 0,
        g = a.body.length; f < g; f++) if (c = a.body[f][b], c = null !== c && c !== s ? c.toString() : "", -1 !== c.indexOf("\n") ? (c = c.split("\n"), c.sort(function(a, c) {
    ...
    if ("undefined" === typeof h || "undefined" !== typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent)) t = void 0;
        ...
        N = function(a) { (h.setImmediate || h.setTimeout)(function() {
                throw a;
            },
            0)
        },
        ...
        F = function(a, b, d) {
            ...
            c.readyState = c.INIT;
            if (L) f = (h.URL || h.webkitURL || h).createObjectURL(a),
            setTimeout(function() {
                x.href = f;
                x.download = b;
                ...
                e.readAsDataURL(a);
                c.readyState = c.INIT
            } else f || (f = (h.URL || h.webkitURL || h).createObjectURL(a)),
            d ? h.location.href = f: h.open(f, "_blank") || (h.location.href = f),
            c.readyState = c.DONE,
            g(),
            D(f)
        },
    ...
    H = function(a, b) {
        for (var d = G(b), c = a.buttons.exportData(b.exportOptions), f = b.fieldBoundary, g = b.fieldSeparator, e = RegExp(f, "g"), n = b.escapeChar !== s ? b.escapeChar: "\\", i = function(a) {
            for (var c = "",
            b = 0,
            d = a.length; b < d; b++) 0 < b && (c += g),
            c += f ? f + ("" + a[b]).replace(e, n + f) + f: a[b];
            return c
        },
        ...
        action: function(a, b, d, c) {
            ...
            if (l.queryCommandSupported("copy")) {
                ...
                try {
                    ...
                    d.remove();
                    if (h) {
                        b.buttons.info(b.i18n("buttons.copyTitle", "复制成功"), b.i18n("buttons.copySuccess", {
    ...
    o.ext.buttons.excelHtml5 = {
        ...
        action: function(a, b, d, c) {
            ...
            for (var o = 0,
            u = d.body.length; o < u; o++) r(d.body[o], g);
            ...
            0 === i("mergeCells", e).children().length && i("mergeCells", e).remove();
            b = new(v || j.JSZip);
            d = {
                type: "blob",
    ...
    o.ext.buttons.pdfHtml5 = {
        ...
        action: function(a, b, d, c) {
            ...
            f = [];
            c.header && f.push(i.map(d.header,
            function(a) {
                return {
            ...
            for (var g = 0,
            e = d.body.length; g < e; g++) f.push(i.map(d.body[g],
            function(a) {
                return {
                    text: "string" === typeof a ? a: a + "",
            ...
            c.footer && d.footer && f.push(i.map(d.footer,
            function(a) {
                return {
                    text: "string" === typeof a ? a: a + "",
                    style: "tableFooter"
